...
class ProfileView(RetrieveUpdateAPIView):
    ...
    def get_object(self):
        queryset = self.get_queryset() #self.queeryset ile aynı burada usttekiqueryset cgrildi
...
class UpdatePassword(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        """
                ...
                bunu kullnmaya grek yok exception dseblr bisey dgisince fln veya bos veride gibi sylerde
...
class CreateUserView(CreateAPIView):
    ...
    permission_classes = [NotAuthenticated] #kayt islemini uye giris ypms kisi ypmamali
